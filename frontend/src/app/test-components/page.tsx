...
const mockPlayerSplitsWithTeammate = {
  ...
  with_teammate_min: 35.2,
  without_teammate_min: 38.8,
  with_teammate_fga: 19.5,
  without_teammate_fga: 23.1,
  with_teammate_fgm: 10.2,
  without_teammate_fgm: 12.5,
  with_teammate_fg_pct: 52.3,
  without_teammate_fg_pct: 54.1
}
