  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <StatComparisonRow
          label="Minutes"
          withValue={splits.with_teammate_min}
          withoutValue={splits.without_teammate_min}
          higherIsBetter={true}
        />
        <StatComparisonRow
          label="FGM"
          withValue={splits.with_teammate_fgm}
          withoutValue={splits.without_teammate_fgm}
          higherIsBetter={true}
        />
        <StatComparisonRow
          label="FGA"
          withValue={splits.with_teammate_fga}
          withoutValue={splits.without_teammate_fga}
          higherIsBetter={true}
        />
        <StatComparisonRow
          label="FG%"
          withValue={splits.with_teammate_fg_pct}
          withoutValue={splits.without_teammate_fg_pct}
          higherIsBetter={true}
        />
        <StatComparisonRow
          label="Usage Rate"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card variant="anthracite">
        <PerformanceCard
          ...
          min={splits.with_teammate_min}
          fgm={splits.with_teammate_fgm}
          fga={splits.with_teammate_fga}
          fgPct={splits.with_teammate_fg_pct}
      ...
      <Card variant="anthracite">
        <PerformanceCard
          ...
          min={splits.without_teammate_min}
          fgm={splits.without_teammate_fgm}
          fga={splits.without_teammate_fga}
          fgPct={splits.without_teammate_fg_pct}
